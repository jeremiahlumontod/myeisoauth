...
//					User.create("admin", passwordEncoder().encode("pass"), "ADMIN", "USER"),
//					User.create("user0", passwordEncoder().encode("pass"), "USER"),
//					User.create("user1", passwordEncoder().encode("pass"), "USER"),
//					User.create("user2", passwordEncoder().encode("pass"), "USER"),
//					User.create("user3", passwordEncoder().encode("pass"), "USER"),
//					User.create("user4", passwordEncoder().encode("pass"), "USER"),
//					User.create("user5", passwordEncoder().encode("pass"), "USER"));
